...
import { UsuarioComponent } from './Componente/Formulario/usuario-form/usuario-form.component';
import { AlimentoComponent } from './Componente/Formulario/alimento-form/alimento-form.component';
...
export const routes: Routes = [
...

  {
    ...
    children: [
      { path: 'inicio', component: UsuarioComponent, canActivate: [AuthGuard] },
      ...
      { path: 'alimento', component: AlimentoComponent, canActivate: [AuthGuard] },
